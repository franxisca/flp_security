...
public class GuardianActor extends AbstractBehavior<GuardianActor.Command> {
    ...
    public static final class Start implements Command {
        ...
        public Start(int active1, Map<Byte, byte[]> defKeys1, Map<Byte, byte[]> sessionKeys1, Map<Integer, Short> vcToDefaultSA1, Map<Short, Byte> criticalSA1, List<Short> standardSA1) {
